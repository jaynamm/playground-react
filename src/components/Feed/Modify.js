    ...
    <>
      <div className='h-screen bg-slate-50 flex flex-col'>
        <nav className='h-14 flex justify-between items-center fixed z-20 w-full bg-white p-2 border'>
          ...
          <button type="button" className='w-10 h-10 p-0 flex items-center justify-center focus:outline-none' onClick={modifyBack}>
            🔙
          </button>
          ...
          <button type="button" className='focus:outline-0 rounded bg-black flex-none px-4 py-2 text-sm opacity-60' onClick={modifySave} >
